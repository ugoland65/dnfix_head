...
<div id="<?= htmlspecialchars($guideId('onahole-second-category-guide'), ENT_QUOTES, 'UTF-8') ?>" style="<?= ($selectedKindCode === 'ONAHOLE' && $selectedSecondKindKey === '') ? '' : 'display:none;' ?>">
    <h3>오나홀 2차 카테고리</h3>
    <ul>
...
<div id="<?= htmlspecialchars($guideId('torso-third-category-guide'), ENT_QUOTES, 'UTF-8') ?>" class="torso-third-category-guide" style="<?= ($selectedKindCode === 'TORSO' && $selectedSecondKindKey === 'TORSO' && $selectedThirdKindKey === '') ? '' : 'display:none;' ?>">
