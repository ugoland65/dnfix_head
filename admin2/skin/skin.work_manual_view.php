...
<div id="contents_body">
	<div id="contents_body_wrap">
		...
		<div class="submitBtnWrap">
			<button type="button" id="" class="btnstyle1 btnstyle1-inverse btnstyle1-lg float-left" onclick="location.href='/ad/staff/work_manual'" > 
				<i class="fas fa-arrow-left"></i> 목록
			</button>
			<button type="button" id="" class="btnstyle1 btnstyle1-primary btnstyle1-lg" onclick="location.href='/ad/staff/work_manual_reg/<?=$_idx?>'" > 
					...
					somethingElse: {
						...
						action: function(){
							...
							$.ajax({
								...
								data : { "a_mode" : "work_file_del", "pmode" : "work_manual", "idx" : idx, "delnum" : delnum   },
								type: "POST",
								dataType: "json",
								success: function(res){
									if ( res.success == true ){
										alert("파일 삭제 완료");
										location.href='/ad/staff/work_manual_view/'+ idx;
									}else{
						...
						action: function(){
							...
							$.ajax({
								...
								success: function(res){
									if (res.success == true ){
										alert("삭제가 완료되었습니다.");
										location.href='/ad/staff/work_manual';
									}else{
										showAlert("Error", res.msg, "alert2" );
										return false;
									}
