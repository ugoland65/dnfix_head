...
//------------------------------------------------------------------------------------------------------------------
	...
	if( $_oprice_mode == "npg" ){
		$_show_code = $comparison_data[CD_CODE3];
	}else{
		$_show_code = $comparison_data[CD_CODE2];
	}
	$_show_jan = $comparison_data[CD_CODE];
	$_show_kind = $koedge_prd_kind_name[$comparison_data[CD_KIND_CODE]];
	$_show_pname = $comparison_data[CD_NAME];
?>
...
<? }else{ ?>
	<td class="text-left" style="width:200px;">
		<input type='text' name='cd_code2' id="code2_<?=$_idx?>" value="<?=$_show_code?>" style="width:80px; height:20px;">
...
<? } ?>
	...
	<td class="text-left">
		<span onclick="comparisonQuick('<?=$_idx?>','info');"><b><?=$_show_pname?></b></span>
...
${'aa_'.$_or_cg_brand}[] = '{"idx":"'.$_idx.'","stockidx":"'.$stock_data[ps_idx].'","code":"'.$_show_code.'","jan":"'.$_show_jan.'","kind":"'.$_show_kind.'","pname":"'.$_show_pname.'","price":"'.$_oprice.'","weight":"'.$_weight.'","om":"","last":"","state":"on"}';
