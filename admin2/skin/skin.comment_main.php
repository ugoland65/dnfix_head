...
<style type="text/css">
	...
	.chat-my-list-wrap::-webkit-scrollbar {
		width: 5px;
		height: 5px;
		border-left: solid 1px rgba(255, 255, 255, .1)
	}

	.chat-my-list-wrap::-webkit-scrollbar-thumb {
		background: #aaa;
	}

	.chat-my-list-wrap>div {
		display: flex;
	...
	.chat-box>ul.chat-profile {
		width: 50px;
	}

	.chat-box>ul.chat-body {
		position: relative;
	}

	.chat-box>ul.chat-body.myc {
		text-align: right;
	}
	...
	.chat-box>ul.chat-body.myc .comment-box {
		background-color: #ffc;
	}

	.chat-box>ul.chat-body.contextOn .comment-box {
		background-color: #9ef7ff;
		border: 1px solid #24d3e3;
	}
