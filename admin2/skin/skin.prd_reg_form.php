...
<? if( $_prd_idx ){ ?>
	...
	<input type="hidden" name="img_add1" value="<?=$prd_data['cd_add_img']['add1']['filename'] ?? ''?>">
	<input type="hidden" name="img_add2" value="<?=$prd_data['cd_add_img']['add2']['filename'] ?? ''?>">
			...
			<td>
				...
				<ul>
					...
					<div class="img-box">
						...
						<?
							if( $prd_data['cd_add_img']['add2']['filename'] ?? '' ){
				...
				<ul>
					...
					<div class="img-box">
						...
						<?
							if( $prd_data['cd_add_img']['add1']['filename'] ?? '' ){
		...
		<td>
			...
			<colgroup>
				...
				<tr>
					...
					<td>
						<label><input type="radio" name="hbti_1" value="S" <? if(($prd_data['cd_hbti_data'][0] ?? '') == "S" ) echo "checked"; ?>> S (Soft)</label>
						<label><input type="radio" name="hbti_1" value="H" <? if(($prd_data['cd_hbti_data'][0] ?? '') == "H" ) echo "checked"; ?>> H (Hard)</label>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<label><input type="radio" name="hbti_2" value="R" <? if(($prd_data['cd_hbti_data'][1] ?? '') == "R" ) echo "checked"; ?>> R (Realistic)</label>
						<label><input type="radio" name="hbti_2" value="F" <? if(($prd_data['cd_hbti_data'][1] ?? '') == "F" ) echo "checked"; ?>> F (Fantasy)</label>
					</td>
					<td>
						<div style="font-size:11px;">
				...
				<tr>
					...
					<td>
						<label><input type="radio" name="hbti_3" value="J" <? if(($prd_data['cd_hbti_data'][2] ?? '') == "J" ) echo "checked"; ?>> J (Judging)</label>
						<label><input type="radio" name="hbti_3" value="P" <? if(($prd_data['cd_hbti_data'][2] ?? '') == "P" ) echo "checked"; ?>> P (Perceiving)</label>
					</td>
					<td>
						<div style="font-size:11px;">
				...
				<tr>
					...
					<td>
						<label><input type="radio" name="hbti_4" value="T" <? if(($prd_data['cd_hbti_data'][3] ?? '') == "T" ) echo "checked"; ?>> T (Technical)</label>
						<label><input type="radio" name="hbti_4" value="E" <? if(($prd_data['cd_hbti_data'][3] ?? '') == "E" ) echo "checked"; ?>> E (Emotional)</label>
					</td>
					<td>
						<div style="font-size:11px;">
