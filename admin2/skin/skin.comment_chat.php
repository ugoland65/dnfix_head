...
.comment-loading > div{ display:inline-block; text-align:center;  }
.comment-loading > div > div.text{  background:rgba(255,255,255,.9); font-weight:600; font-size:14px; margin-top:10px; } 
