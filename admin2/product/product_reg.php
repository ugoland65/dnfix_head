<?
$pageGroup = "product";
$pageName = "product_reg";

include "../lib/inc_common.php";

	$page_title_text = "신규상품 등록";
	$submit_btn_text = "상품 등록";
	...
	<div id="contents_body_wrap">
		<div class="table-wrap">
			 <form name='form1' method='post' action='<?=_A_PATH_PRODUCT_OK?>' enctype="multipart/form-data">
				...
				<input type='hidden' name='a_mode' value='product_new'>
		...
		<table cellspacing="1" cellpadding="0" class="table-style" >
			<tr>
				...
				<td class="tds2" colspan="3"><input type='text' name='pd_name' id='pd_name' size='60' value="<?=$pd_data[PD_NAME]?>" ></td>
			</tr>
			<tr>
				<th class="tds1">상품명 (영문)</th>
				<td class="tds2" colspan="3"><input type='text' name='pd_name_eg' id='pd_name_eg' size='60' value="<?=$pd_data[PD_NAME_EG]?>" ></td>
			</tr>
			<tr>
				<th class="tds1">고유코드</th>
				<td class="tds2" colspan="3"><input type='text' name='PD_SYSTEM_CODE' id='PD_SYSTEM_CODE'  value="<?=$pd_data[PD_SYSTEM_CODE]?>"></td>
			</tr>
		</table>
...
<? */ ?>
		...
		<table cellspacing="1" cellpadding="0" class="table-style" >
            <tr>
                    <th class="tds1">정가</th>
                    <td class="tds2"><input type='text' name='pd_price_o' value="<?= $_view_pd_price_o?>" style="width:100px;" onkeyUP="javascript:is_onlynumeric( this.value, this ); this.value=Comma_int(this.value, this);"></td>

                </tr>
                <tr>
                    <th class="tds1">판매가 (V.M)</th>
                    <td class="tds2">
	...
	<td class="option-price-td">
		<div class="option-price-wrap">
			<ul>
                ...
                <li><input type='text' name='option_price_child[]' value='<?=$_view2_option_price_vm?>' class="price-s" onkeyUP="is_onlynumeric( this.value, this ); this.value=Comma_int(this.value, this);"></li>
			</ul>
			<ul>
                ...
                <li style="padding-top:4px !important;"><input type='text' name='option_price_free_child[]' value='<?=$_view2_option_price_free?>' class="price-s" onkeyUP="is_onlynumeric( this.value, this ); this.value=Comma_int(this.value, this);"></li>
			</ul>
            <ul>
                ...
                <li style="padding-top:4px !important;"><input type='text' name='option_price_cost_child[]' value='<?=$_view2_option_price_cost?>' class="price-s" onkeyUP="is_onlynumeric( this.value, this ); this.value=Comma_int(this.value, this);"></li>
			</ul>
		</div>
	</td>
...
<? } ?>
		...
		<table cellspacing="1" cellpadding="0" class="table-style" >
			<tr>
				...
				<td class="tds2" colspan="3"><textarea name='pd_detail_cont'><?=$pd_data[PD_DETAIL_CONT]?></textarea></td>
			</tr>
			<tr>
				<th class="tds1">기본설명</th>
				<td class="tds2" colspan="3"><textarea name='pd_cont'><?=$pd_data[PD_CONT]?></textarea></td>
			</tr>
			<tr>
				<th class="tds1">사용방법</th>
				<td class="tds2" colspan="3"><textarea name='pd_directions'><?=$pd_data[PD_DIRECTIONS]?></textarea></td>
			</tr>
			<tr>
				<th class="tds1">여행 스토리</th>
				<td class="tds2" colspan="3"><textarea name='pd_tour_story'><?=$pd_data[PD_TOUR_STORY]?></textarea></td>
			</tr>
			<tr>
				<th class="tds1">포함&불포함 사항</th>
				<td class="tds2" colspan="3"><textarea name='pd_inclusion'><?=$pd_data[PD_INCLUSION]?></textarea></td>
			</tr>
			<tr>
				<th class="tds1">취소 및 환불정책</th>
				<td class="tds2" colspan="3"><textarea name='pd_return_policy'><?=$pd_data[PD_RETURN_POLICY]?></textarea></td>
			</tr>
		</table>
		...
		<table cellspacing="1" cellpadding="0" class="table-style" >
			...
			<tr>
				<th class="tds1">동영상 URL</th>
				<td class="tds2" colspan="3"><input type='text' name='pd_video_url' id='pd_video_url'  value="<?=$pd_data[PD_VIDEO_URL]?>"></td>
			</tr>
