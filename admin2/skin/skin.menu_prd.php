...
<div class="left-menu-wrap">
	<ul <? if( $pageNameCode == "product_overview") echo "class='leftMenuNow' "; ?> onclick="location.href='/admin/product/overview'"><li>상품관리 종합현황</li></ul>
	<?php /*
	...
	*/ ?>
	<ul <? if( $pageNameCode == "prd_db_create") echo "class='leftMenuNow' "; ?> onclick="location.href='/admin/product/prd_db_create'"><li>상품 DB 생성</li></ul>
...
<div class="left-menu-wrap">
	...
	<ul <? if( $pageNameCode == "product_relation_group_list" ) echo "class='leftMenuNow' "; ?> onclick="location.href='/admin/product/relation_group_management'"><li>상품 시리즈 관리</li></ul>
	<? /*
