		...
		<?}?>
			...
			<td class="tds2">
				...
				<table cellspacing="0" cellpadding="0" class="table-none-new" >
					...
					<tr>
						<td class="p-3"><input type="text" placeholder="in Date" readonly name="date_start" id='date-range2' value="<?=$_view_bkp_start_date?>"  style="width:100px;"/></td>
						<td class="p-3"><input type="text" placeholder="out Date" readonly  name="date_end" id='date-range3' value="<?=$_view_bkp_arrive_date?>" style="width:100px;"/></td>
					</tr>
				</table>
			...
			<?}?>
				...
				<div class="page-btn-wrap">
					<ul class="page-btn-left">
						<button type="button" id="" class="btnstyle1 btnstyle1-inverse btnstyle1-lg" onclick="location.href='<?=_A_PATH_BOOKING_LIST?><?=$_show_get_url?>'" > 
