<?
	...
	$total_count = wepix_counter("work_unit", $_where);
	...
	$_query = "select * from work_unit ".$_where." ORDER BY idx DESC";
...
<div id="contents_head">
    ...
    <div id="head_write_btn">
		<button type="button" id="" class="btnstyle1 btnstyle1-danger btnstyle1-lg" onclick="workUnit.reg()" > 
	...
	<div id="contents_body_wrap">
		...
		<table class="table-style">	
			...
			<tr align="center" id="trid_<?=$_list['idx']?>" bgcolor="<?=$trcolor?>">
				...
				<td class=""><?=$_list['dept']?></td>
				<td class=""><?=$_list['category']?></td>
				<td class="text-left"><b><?=$_list['subject']?></b></td>
				<td><button type="button" id="show_type_all" class="btnstyle1 btnstyle1-success btnstyle1-sm" onclick="workUnit.view(this, '<?=$_list['idx']?>')"> 수정 </button></td>
			<tr>
			<? }?>
		</table>
